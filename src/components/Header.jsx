              ...
              <div className="flex items-center justify-between h-16">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <a href="/#">
                    <img className="h-8 w-8" src="https://cdn-icons-png.flaticon.com/512/2362/2362779.png" alt="Workflow" />
                    </a>
                 </div>
                ...
                <div className="hidden md:block">
                  <div className="ml-4 flex items-center md:ml-6">
                    ...
                    <button onClick={() => auth.logout()} className="block p-3 text-sm text-gray-500 ">
                      Logout
                    </button>
                  </div>
                </div>

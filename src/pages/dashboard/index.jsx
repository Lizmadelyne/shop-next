...
const PRODUCT_LIMITS = 15;
const PRODUCT_OFFSET = 15;
export default function Dashboard() {
  const products =useFetch(endPoints.products.getProducts(PRODUCT_LIMITS, PRODUCT_OFFSET));
    ...
    datasets:[
      {
        ...
        borderWidth: 2,
        backgroundColor:['#ffbb11', '#c0c0c0', '#50AF95', '#f3b', '#2a2a'],

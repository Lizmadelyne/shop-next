  ...
  return (
    <>
        ...
        <div className="mt-5 flex lg:mt-0 lg:ml-4">
          <span className="sm:ml-3">
            <button
              ...
              type="button"
              className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-lime-700 hover:bg-lime-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
      ...
      <Modal open={opened} setOpen={setOpened}>
        <FormProduct setOpen={setOpened} setAlert={setAlert}/>
      </Modal>      
    </>
  );
 };
